...
{!! Form::open(['route' => 'ciudad_cita.store', 'method' => 'POST']) !!} 
    ...
    <div class="panel-body">
        ...
        <div class="row">   
            <div class="col-md-4 separarBottom">
                ...
                {!! Form::text('ciudad',null, ['class' => 'form-control', 'id'=>'ciudad','required'])  !!}
            ...
            <div class="col-md-4 separarBottom">
                ...
                {!! Form::text('departamento',null, ['class' => 'form-control', 'id'=>'departamento','readonly'])  !!}
            </div>
            <div class="col-md-4 separarBottom">
                {!! Form::label('pais','Pais')  !!}
                {!! Form::text('pais',null, ['class' => 'form-control', 'id'=>'pais','readonly'])  !!}
            </div>
        </div>
